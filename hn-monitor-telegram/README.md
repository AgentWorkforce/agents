...
- Uses the shared Telegram transport (`../shared/telegram.ts`). Idempotency: claims "seen" before posting and never throws once the header has landed (so a retry can't duplicate it).
