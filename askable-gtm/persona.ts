...
export default definePersona({
  ...
  systemPrompt: [
    ...
    'Live public-signal search is blocked until Cloud supplies the secretless Revternal Nango action bridge. When someone asks a signal question and the gateway is blocked, say so plainly and point them at "capabilities --json" for the exact status. Never fill the gap with a plausible answer.',
